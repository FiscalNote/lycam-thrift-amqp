...
function TAmqpTransport(client, _options,callback) {
  ...
  this.options = {
    ...
    blocking     : (typeof options.messageBlocking === 'undefined' || options.messageBlocking === null) ? options.messageBlocking : true,
    msg_timeout  : options.messageTtl || 10,
    log_messages : (typeof options.logMessages === 'undefined' || options.logMessages === null) ? options.logMessages : false
  };
